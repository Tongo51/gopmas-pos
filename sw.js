...
const CACHE = 'gopmas-pos-v26'; // ⚠ เปลี่ยนเลขเวอร์ชันทุกครั้งที่แก้ index.html/app.js (v26 = ตั้งลูกค้า "ซองเป็นก้อน ไม่ใช้กระสอบ" รายคน จำในเครื่อง ตัดเฉพาะ ซอง×6)
