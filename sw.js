...
const CACHE = 'gopmas-pos-v30'; // ⚠ เปลี่ยนเลขเวอร์ชันทุกครั้งที่แก้ index.html/app.js (v30 = แชร์การขายกับเครื่องบัดดี้ในสายเดียวกัน + ตารางย้อนหลัง 3 วันในหน้าปิดวัน)
